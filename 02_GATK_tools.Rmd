...
```{r}
# screenshot maken van snps html met behlup van functie webshot
webshot::webshot("GATK_tools/snpEff_snps_summary.html", "GATK_tools/snps.png")

# screenshot maken van indels html met behlup van functie webshot
webshot::webshot("GATK_tools/snpEff_indels_summary.html", "GATK_tools/indels.png")

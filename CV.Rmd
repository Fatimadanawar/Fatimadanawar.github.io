...
tribble(
  ...
  "B Life Science opleiding", "2020- Tot nu", "Hogeschool Utrecht HU", "Utrecht, Nederland"  
) %>% 
...
tribble(
  ...
  2018, "Vrijwilligerswerk", "Ik ben gewerkt als vrijwiliger in taalcafe in het achterhoek wijk van Nederland"
) %>% 
  brief_entries(
